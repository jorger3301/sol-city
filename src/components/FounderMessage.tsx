...
const MESSAGES: Record<Lang, string[]> = {
  en: [
    ...
    "Sol City was born on a weekend. The idea was simple: what if we stopped looking at green squares on a chart and started seeing what they really are? People. Building things. Every day.",
    ...
    "This antenna you clicked? It's real. It transmits Sol City. And keeping this signal on the air costs. Servers, database, API calls... every new building that goes up, the cost goes up with it.",
    "If Sol City means something to you, help me keep the signal on. Any support keeps this city alive.",
  ...
  pt: [
    ...
    "A Sol City nasceu num final de semana. A ideia era simples: e se a gente parasse de olhar pra quadrados verdes num grafico e comecasse a ver o que eles realmente sao? Pessoas. Construindo coisas. Todo dia.",
    ...
    "Essa antena que voce clicou? E real. Ela transmite a Sol City. E manter esse sinal no ar custa. Servidores, banco de dados, API calls... cada novo predio que sobe, o custo sobe junto.",
    "Se a Sol City significa algo pra voce, me ajuda a manter o sinal ligado. Qualquer apoio mantem essa cidade viva.",
