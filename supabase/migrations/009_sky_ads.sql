...
insert into sky_ads (id, brand, text, description, color, bg_color, link, vehicle, priority) values
  ('solcity', 'Sol City', 'SOLCITY.XYZ ★ SOLANA PROTOCOLS AS A 3D CITY ★ SOLCITY.XYZ', 'Explore Solana protocols as buildings in an interactive 3D pixel art city. Connect your wallet and become a resident.', '#c8e64a', '#1a1018', 'https://solcity.xyz', 'plane', 100),
  ('advertise', 'Sky Ads', 'ADD YOUR AD HERE', 'Want your brand flying over Sol City? Planes, blimps, your colors. Get in touch!', '#f8d880', '#1a1018', 'https://solcity.xyz/advertise', 'plane', 10);
