...
update achievements set description = 'Refer 10 developers to Sol City'  where id = 'recruiter';
...
update achievements set description = 'Refer 30 developers to Sol City'  where id = 'influencer';
update achievements set description = 'Refer 100 developers to Sol City' where id = 'mayor';
